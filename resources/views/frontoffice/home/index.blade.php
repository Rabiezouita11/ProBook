                                ...
                                <aside class="sidebar static left">
                                    ...
                                    @if (auth()->check())
                                        <div class="widget">
                                            ...
                                            <div data-progress="tip" class="progress__outer"
                                                data-value="{{ auth()->user()->image ? '1' : '0.9' }}">
                                                <div class="progress__inner">{{ auth()->user()->image ? '100%' : '90%' }}
                                                </div>
                                            </div>
                                    ...
                                    <div class="widget">
                                        ...
                                        <ul class="recent-links">
                                            <li>
                                                <figure><img alt=""
                                                        src="/frontoffice/images/resources/recentlink-1.jpg"></figure>
                                            ...
                                            <li>
                                                <figure><img alt=""
                                                        src="/frontoffice/images/resources/recentlink-2.jpg"></figure>
                                                <div class="re-links-meta">
                                            ...
                                            <li>
                                                <figure><img alt=""
                                                        src="/frontoffice/images/resources/recentlink-3.jpg"></figure>
                                                <div class="re-links-meta">
                                    ...
                                    <div class="widget web-links stick-widget">
                                        ...
                                        <ul>
                                            ...
                                            <li><i class="icofont-dotted-right"></i> <a title=""
                                                    href="#">Help</a></li>
                                            <li><i class="icofont-dotted-right"></i> <a title=""
                                                    href="#">socimo Gifts</a></li>
                                            <li><i class="icofont-dotted-right"></i> <a title=""
                                                    href="#">content policy</a></li>
                                            <li><i class="icofont-dotted-right"></i> <a title=""
                                                    href="#">User Policy</a></li>
                                        </ul>
                                            ...
                                            <ul class="upload-media">
                                                ...
                                                <li>
                                                    <a href="live-stream.html" title="">
                                                        <i><img src="/frontoffice/images/live-stream.png"
                                                                alt=""></i>
                                            ...
                                            <div class="post-meta">
                                                <figure>
                                                    <a data-toggle="modal" data-target="#img-comt"
                                                        ...
                                                        <img src="/frontoffice/images/resources/study.jpg"
                                                            alt="">
                                                    </a>
                                                </figure>
                                                <a href="post-detail.html" class="post-title">Supervision as a Personnel
                                ...
                                <aside class="sidebar static right">
                                    ...
                                    <div class="widget stick-widget">
                                        ...
                                        <ul class="followers">
                                            <li>
                                                <figure><img alt=""
                                                        src="/frontoffice/images/resources/friend-avatar.jpg"></figure>
                                            ...
                                            <li>
                                                <figure><img alt=""
                                                        src="/frontoffice/images/resources/friend-avatar2.jpg"></figure>
                                                <div class="friend-meta">
                                                    <h4>
                                            ...
                                            <li>
                                                <figure><img alt=""
                                                        src="/frontoffice/images/resources/friend-avatar3.jpg"></figure>
                                                <div class="friend-meta">
                                                    <h4>
                                            ...
                                            <li>
                                                <figure><img alt=""
                                                        src="/frontoffice/images/resources/friend-avatar4.jpg"></figure>
                                                <div class="friend-meta">
                                                    <h4>
                                            ...
                                            <li>
                                                <figure><img alt=""
                                                        src="/frontoffice/images/resources/friend-avatar5.jpg"></figure>
                                                <div class="friend-meta">
                                                    <h4>

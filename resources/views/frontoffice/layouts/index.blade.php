...
<html lang="en">
    <head>
        ...
        <link
            rel="icon"
            href="/frontoffice/images/fav.png"
            type="image/png"
            sizes="16x16"
        >
            ...
            <div class="responsive-header">
                ...
                <div class="user-avatar mobile">
                    <a href="profile.html" title="View Profile">
                        ...
                        @else
                        <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=104d93&color=fff" alt="">
                        @endif
                    </a>
                    <div class="name">
                        ...
                        <a class="" href="messages.html" title="">
                            <i class="">
                                <svg
                                    ...
                                    id="ab2"
                                >
                                    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" style="stroke-dasharray: 68, 88; stroke-dashoffset: 0;"/>
                                </svg>
                            </i>
                            Live Chat
                        </a>
                    ...
                    <div class="container-fluid">
                        <div class="menu-caro">
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="user-inf">
                                        <div class="folowerz">Followers: {{ auth()->user()->abonnes()->count() }}</div>
                                        @php
                        ...
                        <div class="tab-pane fade" id="notifications">
                            ...
                            <ul class="notificationz">
                                ...
                                <li>
                                    ...
                                    <div class="mesg-info">
                                        <span>Alis wells</span>
                                        <a href="#" title="">share your post
                                            <strong>a good time today!</strong>
                                        </a>
                                    </div>
                                </li>
                                <li>
                        ...
                        <div class="post-new">
                            <div class="post-newmeta">
                                <ul class="post-categoroes">
                                    <li>
                                        <i class="icofont-camera"></i> Photo / Video
                                    </li>
                                    <li>
                                        <i class="icofont-google-map"></i> Post Location
                                    </li>
                                    <li>
                                        <i class="icofont-file-gif"></i> Post Gif
                                    </li>
                                    <li>
                                        <i class="icofont-ui-tag"></i> Tag to Friend
                                    </li>
                                    <li>
                                        <i class="icofont-users"></i> Share in Group
                                    </li>
                                    <li>
                                        <i class="icofont-link"></i> Share Link
                                    </li>
                                    <li>
                                        <i class="icofont-video-cam"></i> Go Live
                                    </li>
                                    <li>
                                        <i class="icofont-sale-discount"></i> Post Online Course
                                    </li>
                                    <li>
                                        <i class="icofont-read-book"></i> Post A Book
                                    </li>
                                    <li>
                                        <i class="icofont-globe"></i> Post an Ad
                                    </li>
                                </ul>
                                    ...
                                    <div class="select-box__current" tabindex="1">
                                        <div class="select-box__value">
                                            ...
                                            <p class="select-box__input-text">
                                                <i class="icofont-globe-alt"></i> Public
                                            </p>
                                        </div>
                                        <div class="select-box__value">
                                            <input
                                            ...
                                            >
                                            <p class="select-box__input-text">
                                                <i class="icofont-lock"></i> Private
                                            </p>
                                        </div>
                                        <div class="select-box__value">
                                            <input
                                        ...
                                        <div class="select-box__value">
                                            ...
                                            >
                                            <p class="select-box__input-text">
                                                <i class="icofont-star"></i> Only Friends
                                            </p>
                                        </div>
                                        <div class="select-box__value">
                                            <input
                                        ...
                                        <img
                                            ...
                                            src="/frontoffice/images/arrow-down.svg"
                                            alt="Arrow Icon"
                                            aria-hidden="true"
                                        >
                                    </div>
                                ...
                                <div class="col-lg-9">
                                    <div class="pop-image">
                                        <div class="pop-item">
                                            ...
                                            <figure>
                                                <img src="/frontoffice/images/resources/blog-detail.jpg" alt="">
                                            </figure>

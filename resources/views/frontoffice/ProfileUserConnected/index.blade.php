                                            ...
                                            <div class="row">
                                                <div class="col-lg-8 col-md-6">
                                                    ...
                                                    <ul class="badges">
                                                        ...
                                                        <li><img src="/frontoffice/images/badges/badge3.png"
                                                                alt=""></li>
                                                ...
                                                <div class="tab-pane active fade show " id="posts">
                                                    <div class="row merged20">
                                                        <div class="col-lg-8">
                                                            ...
                                                            @else
                                                            @foreach ($user->publications->reverse() as $publication)
                                                            <div class="main-wraper">
                                                                        <div class="user-post">
                                                                                ...
                                                                                <div class="friend-name">
                                                                                    ...
                                                                                    <ins><a title=""
                                                                                        ...
                                                                                        <span>
                                                                                            ...
                                                                                            published: {{ \Carbon\Carbon::parse($publication->created_at)->isoFormat('MMM, DD YYYY, h:mm A') }}
                                                                                        </span>
                                                                                </div>
                                                                ...
                                                                <div class="widget">
                                                                    ...
                                                                    @foreach ($suggestedUsers as $user)
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <figure>
                                                                                <img alt=""
                                                                                src="{{ asset('users/' . $user->image) }}" height="50px" width="50px">
                                                                                 <a

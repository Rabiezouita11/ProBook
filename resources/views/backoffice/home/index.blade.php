			...
			<div class="panel-content">
				...
				<div class="row merged20 mb-4">
					...
					<div class="col-lg-4 col-md-4 col-sm-4">
						<div class="d-widget soft-green">
							<div class="d-widget-title">
								<h5>nombres jaimes publications</h5>
							</div>
							<div class="d-widget-content" style="height: 100px;"> <!-- Fixed height -->
								<span class="realtime-ico pulse"></span>
								<h6></h6>
					...
					<div class="col-lg-4 col-md-4 col-sm-4">
						<div class="d-widget soft-red">
							<div class="d-widget-title">
								<h5>nombres jaimes commentaires</h5>
							</div>
							<div class="d-widget-content" style="height: 100px;"> <!-- Fixed height -->
								<span class="realtime-ico pulse"></span>
								<h6></h6>
								<h5>{{$jaimeCommentairesCount}}</h5>
								<i class="icofont-heart"></i> <!-- Updated icon class -->
							</div>
						</div>
					</div>
								...
								<tbody>
										...
										<td>
											<div class="d-flex align-items-center">
												<div class="avatar avatar-xs"><img
														src="/backoffice/images/resources/user2.jpg"
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												<div class="avatar avatar-xs"><img
														src="/backoffice/images/resources/user6.jpg"
														class="rounded-circle" alt=""></div>
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												<div class="avatar avatar-xs"><span
														class="avatar-initial rounded-circle bg-primary">r</span></div>
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												<div class="avatar avatar-xs"><span
														class="avatar-initial rounded-circle bg-purple">j</span></div>
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												<div class="avatar avatar-xs"><img
														src="/backoffice/images/resources/user8.jpg"
														class="rounded-circle" alt=""></div>
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												<div class="avatar avatar-xs"><img
														src="/backoffice/images/resources/user7.jpg"
														class="rounded-circle" alt=""></div>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="d-widget">
									...
									<ul class="top-5">
										<li>
											<figure><img src="/backoffice/images/resources/user1.jpg" alt=""><span
													class="status online"></span></figure>
											<a href="#" title="">Big Boss</a>
											<span class="user-active-time">23hrs/day</span>
										</li>
										<li>
											<figure><img src="/backoffice/images/resources/user2.jpg" alt=""><span
													class="status online"></span></figure>
											<a href="#" title="">Sarah Jane</a>
											<span class="user-active-time">22hrs/day</span>
										</li>
										<li>
											<figure><img src="/backoffice/images/resources/user3.jpg" alt=""><span
													class="status online"></span></figure>
											<a href="#" title="">Andrew</a>
											<span class="user-active-time">20hrs/day</span>
										</li>
										<li>
											<figure><img src="/backoffice/images/resources/user4.jpg" alt=""><span
													class="status online"></span></figure>
											<a href="#" title="">Frank</a>
											<span class="user-active-time">19hrs/day</span>
										</li>
										<li>
											<figure><img src="/backoffice/images/resources/user5.jpg" alt=""><span
													class="status online"></span></figure>
							...
							<div class="d-widget-content">
								<table class="table manage-user table-default table-responsive-md">
									...
									<tbody>
										<tr>
											<td>
												<figure><img src="/backoffice/images/resources/user.png" alt="">
												</figure>
												<h5>Maria K.</h5>
											</td>
										...
										<tr>
											<td>
												<figure><img src="/backoffice/images/resources/user2.jpg" alt="">
												</figure>
												<h5>Sarika sing.</h5>
											</td>
											<td><a class="mini-btn" href="#" title="">view</a></td>
										...
										<tr>
											<td>
												<figure><img src="/backoffice/images/resources/user3.jpg" alt="">
												</figure>
												<h5>King Khan</h5>
											</td>
											<td><a class="mini-btn" href="#" title="">view</a></td>
										...
										<tr>
											<td>
												<figure><img src="/backoffice/images/resources/user4.jpg" alt="">
												</figure>
												<h5>jacob</h5>
											</td>
											<td><a class="mini-btn" href="#" title="">view</a></td>
										...
										<tr>
											<td>
												<figure><img src="/backoffice/images/resources/user5.jpg" alt="">
												</figure>
												<h5>Andrew</h5>
											</td>
											<td><a class="mini-btn" href="#" title="">view</a></td>
								...
								<tbody>
									<tr>
										...
										<td class="productss"><a href="#" title=""><img
													src="/backoffice/images/resources/course-1.jpg" alt=""> Html Basics
												Book</a></td>
										<td>17-Oct-20</td>
										<td>$50</td>
										<td>Delivered</td>
									...
									<tr>
										<td>002</td>
										<td class="productss"><a href="#" title=""><img
													src="/backoffice/images/resources/course-2.jpg" alt=""> VU.Js script
												Book</a></td>
										<td>15-Oct-20</td>
										<td>$30</td>
										<td>On Way</td>
									...
									<tr>
										<td>003</td>
										<td class="productss"><a href="#" title=""><img
													src="/backoffice/images/resources/course-3.jpg" alt=""> Online Css3
												Course</a></td>
										<td>07-Oct-20</td>
										<td>$20</td>
										<td>Pending</td>
									...
									<tr>
										<td>004</td>
										<td class="productss"><a href="#" title=""><img
													src="/backoffice/images/resources/course-4.jpg" alt=""> Online
												Course Basic HTML</a></td>
										<td>02-Oct-20</td>
										<td>$10</td>
										<td>Delivered</td>
										<td>Paypal</td>
									...
									<tr>
										<td>005</td>
										<td class="productss"><a href="#" title=""><img
													src="/backoffice/images/resources/course-5.jpg" alt=""> PHP Advance
												Course</a></td>
										<td>27-Sep-20</td>
										<td>$30</td>
										<td>Delivered</td>
									...
									<tr>
										<td>006</td>
										<td class="productss"><a href="#" title=""><img
													src="/backoffice/images/resources/course-6.jpg" alt=""> Advance Wp
												Book</a></td>
										<td>25-Sep-20</td>
										<td>$25</td>
										<td>Return</td>
									...
									<tr>
										<td>007</td>
										<td class="productss"><a href="#" title=""><img
													src="/backoffice/images/resources/course-2.png" alt=""> Online
												Marketing</a></td>
										<td>24-Sep-20</td>
										<td>$22</td>
										<td>Delivered</td>
									...
									<tr>
										<td>008</td>
										<td class="productss"><a href="#" title=""><img
													src="/backoffice/images/resources/course-1.jpg" alt=""> Advance PHP
												Book</a></td>
										<td>20-Sep-20</td>
										<td>$29</td>
										<td>Pending</td>
